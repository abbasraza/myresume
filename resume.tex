...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{Tech Stack}{Embedded Systems, Embedded Linux, Yocto, Linux Kernel, Device Drivers, Device Tree Overlays, C/C++, OOP, JTAG, JLink, systemd, MII/MDI/MDIO, Ethernet PHY, Marvel SW driver, GDB, IGMP/LLMNR/MDNS, I2C/SPI drivers, RS232/485, iMX6ULL, Cortex-M4, uTasker OS, Jenkins, Meson/Ninja, Gitflow, FreeRTOS, AWS IOT}
      \resumeItemListEnd
